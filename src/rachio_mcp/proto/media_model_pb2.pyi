...
class Photo(_message.Message):
    __slots__ = ("id", "photo_type", "parent_id", "created", "updated", "share_permission_granted", "shared_primary", "stock")
    ...
    shared_primary: bool
    stock: bool
    def __init__(self, id: _Optional[str] = ..., photo_type: _Optional[_Union[Photo.PhotoType, str]] = ..., parent_id: _Optional[str] = ..., created: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., updated: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., share_permission_granted: bool = ..., shared_primary: bool = ..., stock: bool = ...) -> None: ...
