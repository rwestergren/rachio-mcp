...
import webhook_pb2 as _webhook_pb2
...
import feature_get_pb2 as _feature_get_pb2
import flow_provision_create_pb2 as _flow_provision_create_pb2
import flow_provision_get_pb2 as _flow_provision_get_pb2
import flow_provision_update_pb2 as _flow_provision_update_pb2
...
class GetProvisionRequest(_message.Message):
    ...
    pin: str
    mac_address: str
    def __init__(self, serial_number: _Optional[str] = ..., pin: _Optional[str] = ..., mac_address: _Optional[str] = ...) -> None: ...

class GetProvisionResponse(_message.Message):
    __slots__ = ("provision",)
    PROVISION_FIELD_NUMBER: _ClassVar[int]
    provision: _provision_pb2.Provision
    def __init__(self, provision: _Optional[_Union[_provision_pb2.Provision, _Mapping]] = ...) -> None: ...
...
class GetProvisionedDeviceResponse(_message.Message):
    ...
    location_id: str
    owner_user_id: str
    def __init__(self, device_id: _Optional[str] = ..., location_id: _Optional[str] = ..., owner_user_id: _Optional[str] = ...) -> None: ...

class CreateProvisionRequest(_message.Message):
    __slots__ = ("serial_number", "pin", "homekit_pin", "status", "manufacturer", "mac", "test_status", "test_result", "model", "firmware_version", "pro", "manufacturing_date", "weather_intelligence_plus", "qr_code_payload")
    SERIAL_NUMBER_FIELD_NUMBER: _ClassVar[int]
    PIN_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, serial_number: _Optional[str] = ..., pin: _Optional[str] = ..., homekit_pin: _Optional[str] = ..., status: _Optional[_Union[_provision_pb2.ProvisionStatus, str]] = ..., manufacturer: _Optional[_Union[_provision_pb2.Manufacturer, str]] = ..., mac: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., test_status: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., test_result: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., model: _Optional[str] = ..., firmware_version: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., pro: bool = ..., manufacturing_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., weather_intelligence_plus: bool = ..., qr_code_payload: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class UpdateProvisionRequest(_message.Message):
    __slots__ = ("serial_number", "status", "mac", "test_status", "test_result", "firmware_version", "pro", "manufacturing_date", "model", "qr_code_payload", "last_known_firmware_version", "refurbished_date")
    SERIAL_NUMBER_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    MAC_FIELD_NUMBER: _ClassVar[int]
    TEST_STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, serial_number: _Optional[str] = ..., status: _Optional[_Union[_provision_pb2.ProvisionStatus, str]] = ..., mac: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., test_status: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., test_result: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., firmware_version: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., pro: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., manufacturing_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., model: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., qr_code_payload: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., last_known_firmware_version: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., refurbished_date: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class AddProvisionFeatureRequest(_message.Message):
    ...
    serial_number: str
    feature_id: str
    def __init__(self, serial_number: _Optional[str] = ..., feature_id: _Optional[str] = ...) -> None: ...
...
class UpdateBasicZoneRequest(_message.Message):
    __slots__ = ("zone_id", "name", "enabled", "soil_type", "crop_type", "nozzle_type", "exposure_type", "photo_bytes", "slope_type", "group_id", "valve_count", "valve_brand", "amperage_monitoring_enabled", "amperage_auto_shut_off_enabled", "baseline_current_milliamps", "high_current_threshold_pct", "low_current_threshold_pct")
    ...
    def __init__(self, zone_id: _Optional[str] = ..., name: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., enabled: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., soil_type: _Optional[_Union[_irrigation_controller_pb2.SoilTypeWrapper, _Mapping]] = ..., crop_type: _Optional[_Union[_irrigation_controller_pb2.CropTypeWrapper, _Mapping]] = ..., nozzle_type: _Optional[_Union[_irrigation_controller_pb2.NozzleTypeWrapper, _Mapping]] = ..., exposure_type: _Optional[_Union[_irrigation_controller_pb2.ExposureTypeWrapper, _Mapping]] = ..., photo_bytes: _Optional[_Union[_wrappers_pb2.BytesValue, _Mapping]] = ..., slope_type: _Optional[_Union[_irrigation_controller_pb2.SlopeTypeWrapper, _Mapping]] = ..., group_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., valve_count: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ..., valve_brand: _Optional[_Union[_zone_pb2.ValveBrandWrapper, _Mapping]] = ..., amperage_monitoring_enabled: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., amperage_auto_shut_off_enabled: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., baseline_current_milliamps: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ..., high_current_threshold_pct: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., low_current_threshold_pct: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ...) -> None: ...

class UpdateBasicZoneResponse(_message.Message):
    __slots__ = ("zone",)
    ZONE_FIELD_NUMBER: _ClassVar[int]
    zone: _zone_pb2.ZoneDetail
    def __init__(self, zone: _Optional[_Union[_zone_pb2.ZoneDetail, _Mapping]] = ...) -> None: ...
...
class UpdatePhotoDetailsRequest(_message.Message):
    ...
    shared_primary: bool
    def __init__(self, id: _Optional[str] = ..., share_permission_granted: bool = ..., shared_primary: bool = ...) -> None: ...

class UpdateYLMPhotoDetailsRequest(_message.Message):
    __slots__ = ("id", "device_id", "code", "share_permission_granted", "shared_primary")
    ID_FIELD_NUMBER: _ClassVar[int]
    DEVICE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    share_permission_granted: bool
    shared_primary: bool
    def __init__(self, id: _Optional[str] = ..., device_id: _Optional[str] = ..., code: _Optional[str] = ..., share_permission_granted: bool = ..., shared_primary: bool = ...) -> None: ...

class UpdatePhotoDetailsResponse(_message.Message):
    __slots__ = ("photo",)
    PHOTO_FIELD_NUMBER: _ClassVar[int]
    photo: _media_model_pb2.Photo
    def __init__(self, photo: _Optional[_Union[_media_model_pb2.Photo, _Mapping]] = ...) -> None: ...

class UpdateAdvancedZoneRequest(_message.Message):
    __slots__ = ("zone_id", "available_water_capacity", "root_zone_depth", "efficiency", "flow_rate", "crop_coefficient", "managed_allowed_depletion", "area", "customer_feedback_scale", "dynamic_crop_coefficient_enabled")
    ZONE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, zone_id: _Optional[str] = ..., available_water_capacity: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., root_zone_depth: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., efficiency: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., flow_rate: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., crop_coefficient: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., managed_allowed_depletion: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., area: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., customer_feedback_scale: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ..., dynamic_crop_coefficient_enabled: bool = ...) -> None: ...
...
class ListZonesRequest(_message.Message):
    ...
    def __init__(self, device_id: _Optional[str] = ..., include_extra_data: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., include_moisture_data: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ...) -> None: ...
...
class GetZoneDetailRequest(_message.Message):
    ...
    zone_id: str
    force_imperial: bool
    def __init__(self, zone_id: _Optional[str] = ..., force_imperial: bool = ...) -> None: ...

class GetZoneDetailResponse(_message.Message):
    __slots__ = ("zone_summary",)
    ZONE_SUMMARY_FIELD_NUMBER: _ClassVar[int]
    zone_summary: ZoneSummary
    def __init__(self, zone_summary: _Optional[_Union[ZoneSummary, _Mapping]] = ...) -> None: ...
...
class ZoneSummary(_message.Message):
    ...
    def __init__(self, zone_detail: _Optional[_Union[_zone_pb2.ZoneDetail, _Mapping]] = ..., zone_state: _Optional[_Union[_controller_state_pb2.ZoneState, _Mapping]] = ...) -> None: ...
...
class GetZonePhotoRequest(_message.Message):
    ...
    zone_id: str
    photo_id: str
    def __init__(self, zone_id: _Optional[str] = ..., photo_id: _Optional[str] = ...) -> None: ...
...
class AddZonePerimeterRequest(_message.Message):
    ...
    zone_perimeter: str
    area: float
    def __init__(self, device_id: _Optional[str] = ..., zone_id: _Optional[str] = ..., zone_perimeter: _Optional[str] = ..., area: _Optional[float] = ...) -> None: ...
...
class AddZoneNozzlesRequest(_message.Message):
    ...
    zone_id: str
    zone_nozzles: str
    def __init__(self, device_id: _Optional[str] = ..., zone_id: _Optional[str] = ..., zone_nozzles: _Optional[str] = ...) -> None: ...
...
class GetZonePerimeterRequest(_message.Message):
    ...
    device_id: str
    zone_id: str
    def __init__(self, device_id: _Optional[str] = ..., zone_id: _Optional[str] = ...) -> None: ...
...
class ListDevicesRequest(_message.Message):
    ...
    location_id: str
    owner_id: str
    def __init__(self, location_id: _Optional[str] = ..., owner_id: _Optional[str] = ...) -> None: ...

class ListDevicesResponse(_message.Message):
    __slots__ = ("device",)
    DEVICE_FIELD_NUMBER: _ClassVar[int]
    device: _containers.RepeatedCompositeFieldContainer[_device_pb2.Device]
    def __init__(self, device: _Optional[_Iterable[_Union[_device_pb2.Device, _Mapping]]] = ...) -> None: ...
...
class GetDeviceDetailsResponse(_message.Message):
    __slots__ = ("gen1_irrigation_controller", "gen2_irrigation_controller", "linked_sensor", "virtual_weather_station", "gen3_irrigation_controller", "wireless_flow_sensor", "virtual_irrigation_controller")
    ...
    virtual_irrigation_controller: _irrigation_controller_pb2.VirtualIrrigationController
    def __init__(self, gen1_irrigation_controller: _Optional[_Union[_irrigation_controller_pb2.Gen1IrrigationController, _Mapping]] = ..., gen2_irrigation_controller: _Optional[_Union[_irrigation_controller_pb2.Gen2IrrigationController, _Mapping]] = ..., linked_sensor: _Optional[_Union[_sensor_pb2.LinkedSensor, _Mapping]] = ..., virtual_weather_station: _Optional[_Union[_weather_station_pb2.VirtualWeatherStation, _Mapping]] = ..., gen3_irrigation_controller: _Optional[_Union[_irrigation_controller_pb2.Gen3IrrigationController, _Mapping]] = ..., wireless_flow_sensor: _Optional[_Union[_sensor_pb2.WirelessFlowSensor, _Mapping]] = ..., virtual_irrigation_controller: _Optional[_Union[_irrigation_controller_pb2.VirtualIrrigationController, _Mapping]] = ...) -> None: ...
...
class GetDeviceStateResponse(_message.Message):
    ...
    def __init__(self, state: _Optional[_Union[_controller_state_pb2.ControllerState, _Mapping]] = ...) -> None: ...
...
class GetNascentIrrigationControllerResponse(_message.Message):
    ...
    nascent_irrigation_controller: _irrigation_controller_pb2.NascentIrrigationController
    def __init__(self, nascent_irrigation_controller: _Optional[_Union[_irrigation_controller_pb2.NascentIrrigationController, _Mapping]] = ...) -> None: ...
...
class GetNascentWirelessFlowSensorResponse(_message.Message):
    ...
    def __init__(self, nascent_wireless_flow_sensor: _Optional[_Union[_sensor_pb2.NascentWirelessFlowSensor, _Mapping]] = ...) -> None: ...

class CreateGen1IrrigationControllerRequest(_message.Message):
    __slots__ = ("name", "geo_point", "location_id", "pin", "agent_id", "external_plan_id", "serial_number", "master_valve", "water_hammer", "wellpump_delay_active", "activation_code")
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, name: _Optional[str] = ..., geo_point: _Optional[_Union[_core_pb2.GeoPoint, _Mapping]] = ..., location_id: _Optional[str] = ..., pin: _Optional[str] = ..., agent_id: _Optional[str] = ..., external_plan_id: _Optional[str] = ..., serial_number: _Optional[str] = ..., master_valve: bool = ..., water_hammer: bool = ..., wellpump_delay_active: bool = ..., activation_code: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class CreateGen1IrrigationControllerResponse(_message.Message):
    ...
    def __init__(self, value: _Optional[_Union[_irrigation_controller_pb2.Gen1IrrigationController, _Mapping]] = ...) -> None: ...

class CreateGen2IrrigationControllerRequest(_message.Message):
    __slots__ = ("name", "geo_point", "location_id", "serial_number", "master_valve", "water_hammer", "wellpump_delay_active", "activation_code")
    NAME_FIELD_NUMBER: _ClassVar[int]
    GEO_POINT_FIELD_NUMBER: _ClassVar[int]
    LOCATION_ID_FIELD_NUMBER: _ClassVar[int]
    SERIAL_NUMBER_FIELD_NUMBER: _ClassVar[int]
    ...
    wellpump_delay_active: bool
    activation_code: _wrappers_pb2.StringValue
    def __init__(self, name: _Optional[str] = ..., geo_point: _Optional[_Union[_core_pb2.GeoPoint, _Mapping]] = ..., location_id: _Optional[str] = ..., serial_number: _Optional[str] = ..., master_valve: bool = ..., water_hammer: bool = ..., wellpump_delay_active: bool = ..., activation_code: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...

class CreateGen2IrrigationControllerResponse(_message.Message):
    __slots__ = ("value",)
    VALUE_FIELD_NUMBER: _ClassVar[int]
    value: _irrigation_controller_pb2.Gen2IrrigationController
    def __init__(self, value: _Optional[_Union[_irrigation_controller_pb2.Gen2IrrigationController, _Mapping]] = ...) -> None: ...
...
class CreateGen3IrrigationControllerResponse(_message.Message):
    ...
    def __init__(self, value: _Optional[_Union[_irrigation_controller_pb2.Gen3IrrigationController, _Mapping]] = ...) -> None: ...
...
class CreateVirtualIrrigationControllerRequest(_message.Message):
    ...
    def __init__(self, name: _Optional[str] = ..., geo_point: _Optional[_Union[_core_pb2.GeoPoint, _Mapping]] = ..., location_id: _Optional[str] = ..., serial_number: _Optional[str] = ..., model: _Optional[_Union[_irrigation_controller_pb2.IrrigationControllerModelType, str]] = ...) -> None: ...
...
class CreateWirelessFlowSensorRequest(_message.Message):
    ...
    controller_id: str
    location_id: str
    def __init__(self, name: _Optional[str] = ..., serial_number: _Optional[str] = ..., controller_id: _Optional[str] = ..., location_id: _Optional[str] = ...) -> None: ...

class CreateWirelessFlowSensorResponse(_message.Message):
    __slots__ = ("value",)
    VALUE_FIELD_NUMBER: _ClassVar[int]
    value: _sensor_pb2.WirelessFlowSensor
    def __init__(self, value: _Optional[_Union[_sensor_pb2.WirelessFlowSensor, _Mapping]] = ...) -> None: ...
...
class UpdateWirelessFlowSensorRequest(_message.Message):
    ...
    id: str
    name: _wrappers_pb2.StringValue
    def __init__(self, id: _Optional[str] = ..., name: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class CreateLocationAndGen1IrrigationControllerRequest(_message.Message):
    ...
    def __init__(self, location: _Optional[_Union[_location_service_pb2.CreateLocationRequest, _Mapping]] = ..., controller: _Optional[_Union[CreateGen1IrrigationControllerRequest, _Mapping]] = ..., property_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class CreateLocationAndGen1IrrigationControllerResponse(_message.Message):
    ...
    def __init__(self, location: _Optional[_Union[_location_pb2.Location, _Mapping]] = ..., controller: _Optional[_Union[_irrigation_controller_pb2.Gen1IrrigationController, _Mapping]] = ...) -> None: ...
...
class CreateLocationAndGen2IrrigationControllerRequest(_message.Message):
    ...
    property_id: _wrappers_pb2.StringValue
    def __init__(self, location: _Optional[_Union[_location_service_pb2.CreateLocationRequest, _Mapping]] = ..., controller: _Optional[_Union[CreateGen2IrrigationControllerRequest, _Mapping]] = ..., property_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class CreateLocationAndGen2IrrigationControllerResponse(_message.Message):
    ...
    def __init__(self, location: _Optional[_Union[_location_pb2.Location, _Mapping]] = ..., controller: _Optional[_Union[_irrigation_controller_pb2.Gen2IrrigationController, _Mapping]] = ...) -> None: ...
...
class CreateLocationAndGen3IrrigationControllerRequest(_message.Message):
    ...
    property_id: _wrappers_pb2.StringValue
    def __init__(self, location: _Optional[_Union[_location_service_pb2.CreateLocationRequest, _Mapping]] = ..., controller: _Optional[_Union[CreateGen3IrrigationControllerRequest, _Mapping]] = ..., property_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ...) -> None: ...
...
class CreateLocationAndGen3IrrigationControllerResponse(_message.Message):
    ...
    def __init__(self, location: _Optional[_Union[_location_pb2.Location, _Mapping]] = ..., controller: _Optional[_Union[_irrigation_controller_pb2.Gen3IrrigationController, _Mapping]] = ...) -> None: ...
...
class CreateLocationAndVirtualIrrigationControllerRequest(_message.Message):
    ...
    def __init__(self, location: _Optional[_Union[_location_service_pb2.CreateLocationRequest, _Mapping]] = ..., controller: _Optional[_Union[CreateVirtualIrrigationControllerRequest, _Mapping]] = ...) -> None: ...
...
class CreateLocationAndVirtualIrrigationControllerResponse(_message.Message):
    ...
    def __init__(self, location: _Optional[_Union[_location_pb2.Location, _Mapping]] = ..., controller: _Optional[_Union[_irrigation_controller_pb2.VirtualIrrigationController, _Mapping]] = ...) -> None: ...

class UpdateIrrigationControllerRequest(_message.Message):
    __slots__ = ("id", "name", "geo_point", "location_id", "master_valve", "standby", "water_hammer", "add_photo_bytes", "remove_photo_id", "weather_intelligence_plus", "wellpump_delay_active", "settle_time", "idle_leak_detection", "idle_leak_time")
    ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    GEO_POINT_FIELD_NUMBER: _ClassVar[int]
    LOCATION_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    add_photo_bytes: _containers.RepeatedCompositeFieldContainer[_wrappers_pb2.BytesValue]
    ...
    def __init__(self, id: _Optional[str] = ..., name: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., geo_point: _Optional[_Union[_core_pb2.GeoPoint, _Mapping]] = ..., location_id: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., master_valve: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., standby: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., water_hammer: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., add_photo_bytes: _Optional[_Iterable[_Union[_wrappers_pb2.BytesValue, _Mapping]]] = ..., remove_photo_id: _Optional[_Iterable[str]] = ..., weather_intelligence_plus: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., wellpump_delay_active: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., settle_time: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ..., idle_leak_detection: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., idle_leak_time: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ...) -> None: ...

class UpdateIrrigationControllerResponse(_message.Message):
    __slots__ = ("gen1_irrigation_controller", "gen2_irrigation_controller", "gen3_irrigation_controller", "virtual_irrigation_controller")
    GEN1_IRRIGATION_CONTROLLER_FIELD_NUMBER: _ClassVar[int]
    GEN2_IRRIGATION_CONTROLLER_FIELD_NUMBER: _ClassVar[int]
    GEN3_IRRIGATION_CONTROLLER_FIELD_NUMBER: _ClassVar[int]
    VIRTUAL_IRRIGATION_CONTROLLER_FIELD_NUMBER: _ClassVar[int]
    ...
    gen3_irrigation_controller: _irrigation_controller_pb2.Gen3IrrigationController
    virtual_irrigation_controller: _irrigation_controller_pb2.VirtualIrrigationController
    def __init__(self, gen1_irrigation_controller: _Optional[_Union[_irrigation_controller_pb2.Gen1IrrigationController, _Mapping]] = ..., gen2_irrigation_controller: _Optional[_Union[_irrigation_controller_pb2.Gen2IrrigationController, _Mapping]] = ..., gen3_irrigation_controller: _Optional[_Union[_irrigation_controller_pb2.Gen3IrrigationController, _Mapping]] = ..., virtual_irrigation_controller: _Optional[_Union[_irrigation_controller_pb2.VirtualIrrigationController, _Mapping]] = ...) -> None: ...
...
class ListDevicePhotosResponse(_message.Message):
    ...
    def __init__(self, photo_id: _Optional[_Iterable[_Union[_wrappers_pb2.StringValue, _Mapping]]] = ...) -> None: ...
...
class GetDevicePhotosResponse(_message.Message):
    ...
    def __init__(self, photo_bytes: _Optional[_Iterable[_Union[_wrappers_pb2.BytesValue, _Mapping]]] = ...) -> None: ...
...
class GetDevicePhotoRequest(_message.Message):
    ...
    device_id: str
    photo_id: str
    def __init__(self, device_id: _Optional[str] = ..., photo_id: _Optional[str] = ...) -> None: ...
...
class UpdateLinkedSensorRequest(_message.Message):
    __slots__ = ("id", "make", "model", "kfactor", "offset", "enabled", "sensorType", "linked_controller_id")
    ...
    def __init__(self, id: _Optional[str] = ..., make: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., model: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., kfactor: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., offset: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., enabled: bool = ..., sensorType: _Optional[_Union[UpdateLinkedSensorRequest.LinkedSensorType, str]] = ..., linked_controller_id: _Optional[str] = ...) -> None: ...

class UpdateLinkedSensorResponse(_message.Message):
    __slots__ = ("value",)
    VALUE_FIELD_NUMBER: _ClassVar[int]
    value: _sensor_pb2.LinkedSensor
    def __init__(self, value: _Optional[_Union[_sensor_pb2.LinkedSensor, _Mapping]] = ...) -> None: ...
...
class GetDesiredFirmwareResponse(_message.Message):
    __slots__ = ("device_id", "current_firmware_name", "desired_firmware_name", "desired_firmware_url")
    DEVICE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, device_id: _Optional[str] = ..., current_firmware_name: _Optional[str] = ..., desired_firmware_name: _Optional[str] = ..., desired_firmware_url: _Optional[str] = ...) -> None: ...
...
class SetManualScheduleRequest(_message.Message):
    __slots__ = ("device_id", "runs", "cycle_soak", "cycle_soak_duration", "cycle_duration", "soak_duration")
    DEVICE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, device_id: _Optional[str] = ..., runs: _Optional[_Iterable[_Union[ManualZoneRun, _Mapping]]] = ..., cycle_soak: bool = ..., cycle_soak_duration: _Optional[int] = ..., cycle_duration: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ..., soak_duration: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ...) -> None: ...
...
class ManualZoneRun(_message.Message):
    ...
    duration: int
    zone_number: int
    def __init__(self, duration: _Optional[int] = ..., zone_number: _Optional[int] = ...) -> None: ...
...
class StartZoneCalibrationResponse(_message.Message):
    ...
    manual_schedule_id: int
    correlation_id: int
    def __init__(self, manual_schedule_id: _Optional[int] = ..., correlation_id: _Optional[int] = ...) -> None: ...
...
class SetRainDelayRequest(_message.Message):
    ...
    def __init__(self, device_id: _Optional[str] = ..., rain_delay_expiration: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class GetZoneDefaultResponse(_message.Message):
    ...
    def __init__(self, zoneDefault: _Optional[_Union[ZoneDefault, _Mapping]] = ...) -> None: ...

class ZoneDefault(_message.Message):
    __slots__ = ("available_water_capacity", "root_zone_depth", "efficiency", "flow_rate", "crop_coefficient", "managed_allowed_depletion")
    AVAILABLE_WATER_CAPACITY_FIELD_NUMBER: _ClassVar[int]
    ROOT_ZONE_DEPTH_FIELD_NUMBER: _ClassVar[int]
    EFFICIENCY_FIELD_NUMBER: _ClassVar[int]
    FLOW_RATE_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, available_water_capacity: _Optional[float] = ..., root_zone_depth: _Optional[float] = ..., efficiency: _Optional[float] = ..., flow_rate: _Optional[float] = ..., crop_coefficient: _Optional[float] = ..., managed_allowed_depletion: _Optional[float] = ...) -> None: ...
...
class GetCalendarRequest(_message.Message):
    ...
    def __init__(self, device_id: _Optional[str] = ..., start_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., end_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class GetCalendarResponse(_message.Message):
    ...
    def __init__(self, version_id: _Optional[int] = ..., runs: _Optional[_Iterable[_Union[_schedule_run_pb2.ScheduleRun, _Mapping]]] = ..., skips: _Optional[_Iterable[_Union[_skip_sequence_pb2.SkipSequence, _Mapping]]] = ...) -> None: ...
...
class GetYardLikeMineRequest(_message.Message):
    ...
    def __init__(self, device_id: _Optional[str] = ..., offset: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ..., limit: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ...) -> None: ...

class GetYardLikeMineResponse(_message.Message):
    __slots__ = ("water_usage", "green_score", "yard", "end_of_yard_list", "current_list_offset")
    ...
    def __init__(self, water_usage: _Optional[float] = ..., green_score: _Optional[float] = ..., yard: _Optional[_Iterable[_Union[_yard_like_mine_pb2.YardLikeMine, _Mapping]]] = ..., end_of_yard_list: bool = ..., current_list_offset: _Optional[_Union[_wrappers_pb2.Int32Value, _Mapping]] = ...) -> None: ...
...
class GetYardLikeMineDetailResponse(_message.Message):
    __slots__ = ("device_id", "water_usage", "zone_photo_id", "schedule_types", "updated", "is_updated")
    DEVICE_ID_FIELD_NUMBER: _ClassVar[int]
    WATER_USAGE_FIELD_NUMBER: _ClassVar[int]
    ...
    schedule_types: _containers.RepeatedScalarFieldContainer[_schedule_criteria_pb2.ScheduleType]
    updated: _timestamp_pb2.Timestamp
    is_updated: bool
    def __init__(self, device_id: _Optional[str] = ..., water_usage: _Optional[float] = ..., zone_photo_id: _Optional[_Iterable[str]] = ..., schedule_types: _Optional[_Iterable[_Union[_schedule_criteria_pb2.ScheduleType, str]]] = ..., updated: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., is_updated: bool = ...) -> None: ...
...
class SkipForwardZoneRunResponse(_message.Message):
    ...
    def __init__(self, running_zone: _Optional[_Union[_controller_state_pb2.ZoneRun, _Mapping]] = ..., running_schedule: _Optional[_Union[_controller_state_pb2.ImmediateScheduleRun, _Mapping]] = ...) -> None: ...
...
class PauseZoneRunRequest(_message.Message):
    ...
    device_id: str
    seconds_paused: int
    def __init__(self, device_id: _Optional[str] = ..., seconds_paused: _Optional[int] = ...) -> None: ...
...
class ExtendZoneRunRequest(_message.Message):
    ...
    def __init__(self, device_id: _Optional[str] = ..., seconds_extended: _Optional[int] = ...) -> None: ...
...
class StopWateringQRRequest(_message.Message):
    ...
    device_id: str
    code: str
    def __init__(self, device_id: _Optional[str] = ..., code: _Optional[str] = ...) -> None: ...
...
class SetManualScheduleQRRequest(_message.Message):
    ...
    runs: _containers.RepeatedCompositeFieldContainer[ManualZoneRun]
    code: str
    def __init__(self, device_id: _Optional[str] = ..., runs: _Optional[_Iterable[_Union[ManualZoneRun, _Mapping]]] = ..., code: _Optional[str] = ...) -> None: ...
...
class PauseZoneRunQRRequest(_message.Message):
    ...
    seconds_paused: int
    code: str
    def __init__(self, device_id: _Optional[str] = ..., seconds_paused: _Optional[int] = ..., code: _Optional[str] = ...) -> None: ...
...
class ExtendZoneRunQRRequest(_message.Message):
    ...
    seconds_extended: int
    code: str
    def __init__(self, device_id: _Optional[str] = ..., seconds_extended: _Optional[int] = ..., code: _Optional[str] = ...) -> None: ...
...
class GetFlowSensorDataResponse(_message.Message):
    ...
    flow_sensor_data: _containers.RepeatedCompositeFieldContainer[_sensor_pb2.FlowSensor]
    def __init__(self, flow_sensor_data: _Optional[_Iterable[_Union[_sensor_pb2.FlowSensor, _Mapping]]] = ...) -> None: ...
...
class GetLastZoneRunStateResponse(_message.Message):
    ...
    def __init__(self, last_zone_run_states: _Optional[_Iterable[_Union[LastZoneRunState, _Mapping]]] = ...) -> None: ...

class LastZoneRunState(_message.Message):
    __slots__ = ("id", "device_id", "zone_number", "last_run_start_current", "last_run_end_current", "last_run_start_time", "last_run_end_time")
    ID_FIELD_NUMBER: _ClassVar[int]
    DEVICE_ID_FIELD_NUMBER: _ClassVar[int]
    ZONE_NUMBER_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[str] = ..., device_id: _Optional[str] = ..., zone_number: _Optional[int] = ..., last_run_start_current: _Optional[int] = ..., last_run_end_current: _Optional[int] = ..., last_run_start_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., last_run_end_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class GetActiveAlertsRequest(_message.Message):
    ...
    def __init__(self, device_id: _Optional[_Union[_core_pb2.StringList, _Mapping]] = ..., zone_id: _Optional[_Union[_core_pb2.StringList, _Mapping]] = ...) -> None: ...
...
class DismissAlertsRequest(_message.Message):
    ...
    device_id: str
    zone_id: str
    def __init__(self, alert_ids: _Optional[_Iterable[str]] = ..., device_id: _Optional[str] = ..., zone_id: _Optional[str] = ...) -> None: ...
...
class UpdateZoneFlowRequest(_message.Message):
    __slots__ = ("zone_id", "flow_metering_enabled", "flow_auto_shut_off_enabled", "flow_high_threshold_pct", "flow_low_threshold_pct", "flow_baseline", "flow_calibration_result")
    ZONE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, zone_id: _Optional[str] = ..., flow_metering_enabled: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., flow_auto_shut_off_enabled: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., flow_high_threshold_pct: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., flow_low_threshold_pct: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., flow_baseline: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., flow_calibration_result: _Optional[_Union[_irrigation_controller_pb2.FlowCalibrationResultWrapper, _Mapping]] = ...) -> None: ...
...
class CopyIrrigationControllerRequest(_message.Message):
    ...
    def __init__(self, source_device_id: _Optional[str] = ..., destination_device_id: _Optional[str] = ...) -> None: ...
...
class GetNetworkStateResponse(_message.Message):
    __slots__ = ("device_id", "pin", "rssi", "dns1", "dns2", "netmask", "gateway", "ip_address", "ssid", "band")
    DEVICE_ID_FIELD_NUMBER: _ClassVar[int]
    PIN_FIELD_NUMBER: _ClassVar[int]
    ...
    ssid: str
    band: str
    def __init__(self, device_id: _Optional[str] = ..., pin: _Optional[str] = ..., rssi: _Optional[int] = ..., dns1: _Optional[str] = ..., dns2: _Optional[str] = ..., netmask: _Optional[str] = ..., gateway: _Optional[str] = ..., ip_address: _Optional[str] = ..., ssid: _Optional[str] = ..., band: _Optional[str] = ...) -> None: ...
...
class AddDeviceFeatureRequest(_message.Message):
    ...
    def __init__(self, device_id: _Optional[str] = ..., name: _Optional[_Union[_feature_pb2.Feature.FeatureName, str]] = ..., group: _Optional[_Union[_feature_pb2.Feature.FeatureGroup, str]] = ...) -> None: ...
...
class DebugFlowRequest(_message.Message):
    ...
    device_id: str
    duration: int
    def __init__(self, device_id: _Optional[str] = ..., duration: _Optional[int] = ...) -> None: ...
...
class LastSeenControllerResponse(_message.Message):
    ...
    def __init__(self, lastSeen: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class AssignProvisionRequest(_message.Message):
    ...
    manufacturer: _provision_pb2.Manufacturer
    model: _irrigation_controller_pb2.IrrigationControllerModelType
    def __init__(self, manufacturer: _Optional[_Union[_provision_pb2.Manufacturer, str]] = ..., model: _Optional[_Union[_irrigation_controller_pb2.IrrigationControllerModelType, str]] = ...) -> None: ...
...
class SetLightBarSettingRequest(_message.Message):
    ...
    def __init__(self, device_id: _Optional[str] = ..., light_bar_setting: _Optional[_Union[_controller_state_pb2.ControllerState.LightBarSetting, str]] = ...) -> None: ...
...
class CreateZoneGroupRequest(_message.Message):
    __slots__ = ("device_id", "type", "name", "description", "area", "activity_level", "yard_health", "perimeter", "zone_ids")
    DEVICE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, device_id: _Optional[str] = ..., type: _Optional[_Union[_zone_pb2.ZoneGroupType, str]] = ..., name: _Optional[str] = ..., description: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., area: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., activity_level: _Optional[_Union[_irrigation_controller_pb2.ActivityLevelWrapper, _Mapping]] = ..., yard_health: _Optional[_Union[_irrigation_controller_pb2.YardHealthWrapper, _Mapping]] = ..., perimeter: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., zone_ids: _Optional[_Iterable[str]] = ...) -> None: ...
...
class CreateZoneGroupResponse(_message.Message):
    ...
    def __init__(self, zone_group: _Optional[_Union[_zone_pb2.ZoneGroup, _Mapping]] = ...) -> None: ...

class UpdateZoneGroupRequest(_message.Message):
    __slots__ = ("id", "device_id", "type", "name", "description", "area", "activity_level", "yard_health", "perimeter", "zone_ids")
    ID_FIELD_NUMBER: _ClassVar[int]
    DEVICE_ID_FIELD_NUMBER: _ClassVar[int]
    TYPE_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    ...
    def __init__(self, id: _Optional[str] = ..., device_id: _Optional[str] = ..., type: _Optional[_Union[_zone_pb2.ZoneGroupTypeWrapper, _Mapping]] = ..., name: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., description: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., area: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., activity_level: _Optional[_Union[_irrigation_controller_pb2.ActivityLevelWrapper, _Mapping]] = ..., yard_health: _Optional[_Union[_irrigation_controller_pb2.YardHealthWrapper, _Mapping]] = ..., perimeter: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., zone_ids: _Optional[_Union[_core_pb2.StringList, _Mapping]] = ...) -> None: ...
...
class ListZoneGroupsResponse(_message.Message):
    ...
    def __init__(self, zone_groups: _Optional[_Iterable[_Union[_zone_pb2.ZoneGroup, _Mapping]]] = ...) -> None: ...
...
class BirthGen1Request(_message.Message):
    ...
    serial_number: str
    user_id: str
    def __init__(self, serial_number: _Optional[str] = ..., user_id: _Optional[str] = ...) -> None: ...
...
class GetExtendedWarrantyEligibilityRequest(_message.Message):
    ...
    user_id: str
    device_id: str
    def __init__(self, user_id: _Optional[str] = ..., device_id: _Optional[str] = ...) -> None: ...

class GetExtendedWarrantyEligibilityResponse(_message.Message):
    __slots__ = ("extendedWarrantyEligibilityStatus", "purchaseUrl")
    class ExtendedWarrantyEligibilityStatus(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
        __slots__ = ()
        INELIGIBLE: _ClassVar[GetExtendedWarrantyEligibilityResponse.ExtendedWarrantyEligibilityStatus]
        ELIGIBLE: _ClassVar[GetExtendedWarrantyEligibilityResponse.ExtendedWarrantyEligibilityStatus]
        ACTIVE: _ClassVar[GetExtendedWarrantyEligibilityResponse.ExtendedWarrantyEligibilityStatus]
    ...
    extendedWarrantyEligibilityStatus: GetExtendedWarrantyEligibilityResponse.ExtendedWarrantyEligibilityStatus
    purchaseUrl: str
    def __init__(self, extendedWarrantyEligibilityStatus: _Optional[_Union[GetExtendedWarrantyEligibilityResponse.ExtendedWarrantyEligibilityStatus, str]] = ..., purchaseUrl: _Optional[str] = ...) -> None: ...
...
class UpdateDynamicCropCoefficientRequest(_message.Message):
    ...
    zone_ids: _containers.RepeatedScalarFieldContainer[str]
    enabled: bool
    def __init__(self, device_id: _Optional[str] = ..., zone_ids: _Optional[_Iterable[str]] = ..., enabled: bool = ...) -> None: ...
