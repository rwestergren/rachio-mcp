...
class ScheduleZoneInfo(_message.Message):
    __slots__ = (
        ...
        "order_id",
        "watering_time",
        "flex_aggression_coefficient",
        "flex_runtime_coefficient",
    )
    ...
    def __init__(
        ...
        watering_time: _Optional[int] = ...,
        flex_aggression_coefficient: _Optional[float] = ...,
        flex_runtime_coefficient: _Optional[float] = ...,
    ) -> None: ...
