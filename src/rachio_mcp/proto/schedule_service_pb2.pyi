...
class GetLocationsAndDevicesForScheduleResponse(_message.Message):
    ...
    schedule_location_info: _containers.RepeatedCompositeFieldContainer[ScheduleLocationInfo]
    def __init__(self, schedule_location_info: _Optional[_Iterable[_Union[ScheduleLocationInfo, _Mapping]]] = ...) -> None: ...
...
class ScheduleLocationInfo(_message.Message):
    ...
    def __init__(self, location_id: _Optional[str] = ..., device_id: _Optional[_Iterable[str]] = ...) -> None: ...

class CreateScheduleRequest(_message.Message):
    __slots__ = ("name", "schedule_criteria", "schedule_restriction_criteria", "zone_info", "enabled", "color", "koppen_reduction_factor", "annual_start_on_notifications_enabled", "annual_end_on_notifications_enabled")
    ...
    def __init__(self, name: _Optional[str] = ..., schedule_criteria: _Optional[_Union[_schedule_criteria_pb2.ScheduleCriteria, _Mapping]] = ..., schedule_restriction_criteria: _Optional[_Union[_schedule_restriction_criteria_pb2.ScheduleRestrictionCriteria, _Mapping]] = ..., zone_info: _Optional[_Iterable[_Union[_schedule_zone_info_pb2.ScheduleZoneInfo, _Mapping]]] = ..., enabled: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., color: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., koppen_reduction_factor: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., annual_start_on_notifications_enabled: bool = ..., annual_end_on_notifications_enabled: bool = ...) -> None: ...
...
class GetSchedulesRequest(_message.Message):
    ...
    def __init__(self, schedule_id: _Optional[_Union[_core_pb2.StringList, _Mapping]] = ..., zone_id: _Optional[_Union[_core_pb2.StringList, _Mapping]] = ..., device_id: _Optional[_Union[_core_pb2.StringList, _Mapping]] = ..., location_id: _Optional[_Union[_core_pb2.StringList, _Mapping]] = ...) -> None: ...

class GetSchedulesResponse(_message.Message):
    __slots__ = ("schedule",)
    SCHEDULE_FIELD_NUMBER: _ClassVar[int]
    schedule: _containers.RepeatedCompositeFieldContainer[_schedule_pb2.Schedule]
    def __init__(self, schedule: _Optional[_Iterable[_Union[_schedule_pb2.Schedule, _Mapping]]] = ...) -> None: ...

class UpdateScheduleRequest(_message.Message):
    __slots__ = ("schedule_id", "name", "schedule_criteria", "schedule_restriction_criteria", "zone_info_to_add_or_update", "zone_ids_to_remove", "enabled", "color", "koppen_reduction_factor", "annual_start_on_notifications_enabled", "annual_end_on_notifications_enabled", "use_forecast_weather_for_precip_skip")
    SCHEDULE_ID_FIELD_NUMBER: _ClassVar[int]
    NAME_FIELD_NUMBER: _ClassVar[int]
    SCHEDULE_CRITERIA_FIELD_NUMBER: _ClassVar[int]
    SCHEDULE_RESTRICTION_CRITERIA_FIELD_NUMBER: _ClassVar[int]
    ...
    schedule_criteria: _schedule_criteria_pb2.ScheduleCriteria
    schedule_restriction_criteria: _schedule_restriction_criteria_pb2.ScheduleRestrictionCriteria
    zone_info_to_add_or_update: _containers.RepeatedCompositeFieldContainer[_schedule_zone_info_pb2.ScheduleZoneInfo]
    ...
    def __init__(self, schedule_id: _Optional[str] = ..., name: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., schedule_criteria: _Optional[_Union[_schedule_criteria_pb2.ScheduleCriteria, _Mapping]] = ..., schedule_restriction_criteria: _Optional[_Union[_schedule_restriction_criteria_pb2.ScheduleRestrictionCriteria, _Mapping]] = ..., zone_info_to_add_or_update: _Optional[_Iterable[_Union[_schedule_zone_info_pb2.ScheduleZoneInfo, _Mapping]]] = ..., zone_ids_to_remove: _Optional[_Iterable[str]] = ..., enabled: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., color: _Optional[_Union[_wrappers_pb2.StringValue, _Mapping]] = ..., koppen_reduction_factor: _Optional[_Union[_wrappers_pb2.DoubleValue, _Mapping]] = ..., annual_start_on_notifications_enabled: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., annual_end_on_notifications_enabled: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ..., use_forecast_weather_for_precip_skip: _Optional[_Union[_wrappers_pb2.BoolValue, _Mapping]] = ...) -> None: ...
...
class SetSkipRequest(_message.Message):
    ...
    schedule_id: str
    disabled: bool
    def __init__(self, schedule_id: _Optional[str] = ..., disabled: bool = ...) -> None: ...

class SetSkipResponse(_message.Message):
    __slots__ = ("skip",)
    SKIP_FIELD_NUMBER: _ClassVar[int]
    skip: _skip_sequence_pb2.SkipSequence
    def __init__(self, skip: _Optional[_Union[_skip_sequence_pb2.SkipSequence, _Mapping]] = ...) -> None: ...
...
class GetScheduleRunsRequest(_message.Message):
    ...
    def __init__(self, schedule_id: _Optional[str] = ..., start_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., end_time: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...
...
class GetScheduleRunsResponse(_message.Message):
    ...
    def __init__(self, runs: _Optional[_Iterable[_Union[_schedule_run_pb2.ScheduleRun, _Mapping]]] = ..., skips: _Optional[_Iterable[_Union[_skip_sequence_pb2.SkipSequence, _Mapping]]] = ...) -> None: ...

class PreviewScheduleRequest(_message.Message):
    __slots__ = ("name", "schedule_criteria", "schedule_restriction_criteria", "zone_info")
    NAME_FIELD_NUMBER: _ClassVar[int]
    SCHEDULE_CRITERIA_FIELD_NUMBER: _ClassVar[int]
    SCHEDULE_RESTRICTION_CRITERIA_FIELD_NUMBER: _ClassVar[int]
    ZONE_INFO_FIELD_NUMBER: _ClassVar[int]
    ...
    schedule_restriction_criteria: _schedule_restriction_criteria_pb2.ScheduleRestrictionCriteria
    zone_info: _containers.RepeatedCompositeFieldContainer[_schedule_zone_info_pb2.ScheduleZoneInfo]
    def __init__(self, name: _Optional[str] = ..., schedule_criteria: _Optional[_Union[_schedule_criteria_pb2.ScheduleCriteria, _Mapping]] = ..., schedule_restriction_criteria: _Optional[_Union[_schedule_restriction_criteria_pb2.ScheduleRestrictionCriteria, _Mapping]] = ..., zone_info: _Optional[_Iterable[_Union[_schedule_zone_info_pb2.ScheduleZoneInfo, _Mapping]]] = ...) -> None: ...
...
class GetScheduleAdjustmentResponse(_message.Message):
    ...
    def __init__(self, schedule_adjustment: _Optional[_Union[_schedule_adjustment_pb2.ScheduleAdjustment, _Mapping]] = ...) -> None: ...
...
class ListScheduleAdjustmentsByDeviceIdResponse(_message.Message):
    ...
    def __init__(self, schedule_adjustments: _Optional[_Iterable[_Union[_schedule_adjustment_pb2.ScheduleAdjustment, _Mapping]]] = ...) -> None: ...
...
class UpdateScheduleAdjustmentRequest(_message.Message):
    ...
    def __init__(self, id: _Optional[str] = ..., state: _Optional[_Union[_schedule_adjustment_pb2.ScheduleAdjustmentStateWrapper, _Mapping]] = ...) -> None: ...
