...
class User(_message.Message):
    ...
    class Membership(_message.Message):
        ...
        def __init__(
            ...
            role: _Optional[_Union[User.Membership.Role, str]] = ...,
    ...
    last_name: str
    email_address: str
    preference: _containers.RepeatedCompositeFieldContainer[
        _user_preference_pb2.UserPreference
    ]
    ...
    def __init__(
        ...
        preference: _Optional[
            _Iterable[_Union[_user_preference_pb2.UserPreference, _Mapping]]
        ] = ...,
        created: _Optional[
        ...
        pro: bool = ...,
        role: _Optional[_Iterable[_Union[_auth_extension_pb2.AuthRole, str]]] = ...,
        privacy_constraint: _Optional[_Union[User.PrivacyConstraint, str]] = ...,
        membership: _Optional[_Union[User.Membership, _Mapping]] = ...,
        photo_summary: _Optional[_Union[_media_model_pb2.PhotoSummary, _Mapping]] = ...,
    ) -> None: ...
...
class EventToken(_message.Message):
    ...
    def __init__(
        ...
        type: _Optional[_Union[EventTokenType, str]] = ...,
    ) -> None: ...
