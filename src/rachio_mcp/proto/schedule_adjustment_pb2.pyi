...
class ScheduleAdjustment(_message.Message):
    __slots__ = (
        ...
        "start_date",
        "end_date",
        "watering_time_multiplier",
        "state",
        "watering_cadence_adjustment",
        "temperature_monitoring_watering_adjustment_id",
    )
    ...
    def __init__(
        ...
        watering_time_multiplier: _Optional[
            _Union[_wrappers_pb2.DoubleValue, _Mapping]
        ] = ...,
        state: _Optional[_Union[ScheduleAdjustmentState, str]] = ...,
        watering_cadence_adjustment: _Optional[
            _Union[ScheduleAdjustment.WateringCadenceAdjustment, str]
        ] = ...,
        temperature_monitoring_watering_adjustment_id: _Optional[
...
class ScheduleAdjustmentStateWrapper(_message.Message):
    ...
    def __init__(
        self, value: _Optional[_Union[ScheduleAdjustmentState, str]] = ...
    ) -> None: ...
