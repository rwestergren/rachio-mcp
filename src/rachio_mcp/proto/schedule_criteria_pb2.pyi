...
class ScheduleCriteria(_message.Message):
    __slots__ = (
        ...
        "end_time_set",
        "end_sun_time",
        "start_time_with_end_time_boundary",
    )
    ...
    def __init__(
        self,
        schedule_type: _Optional[_Union[ScheduleType, str]] = ...,
        start_date: _Optional[_Union[_core_pb2.Date, _Mapping]] = ...,
        end_date: _Optional[_Union[_core_pb2.Date, _Mapping]] = ...,
        annual_start_date: _Optional[_Union[_core_pb2.CalendarDate, _Mapping]] = ...,
        annual_end_date: _Optional[_Union[_core_pb2.CalendarDate, _Mapping]] = ...,
        rain_delay_enabled: bool = ...,
        freeze_delay_enabled: bool = ...,
        wind_delay_enabled: bool = ...,
        climate_skip: bool = ...,
        ...
        smart_cycle: bool = ...,
        cycle_soak: bool = ...,
        soak_time: _Optional[int] = ...,
        cycle_time: _Optional[int] = ...,
        zone_delay_time: _Optional[int] = ...,
        start_time_set: _Optional[_Union[_core_pb2.TimeList, _Mapping]] = ...,
        start_sun_time: _Optional[str] = ...,
        end_time_set: _Optional[_Union[_core_pb2.TimeList, _Mapping]] = ...,
        end_sun_time: _Optional[str] = ...,
        start_time_with_end_time_boundary: _Optional[
            _Union[_core_pb2.TimeInterval, _Mapping]
        ] = ...,
    ) -> None: ...
